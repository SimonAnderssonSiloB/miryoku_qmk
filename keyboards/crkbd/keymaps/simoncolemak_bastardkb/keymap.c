// Custom Colemak DH layout for BastardKB Charybdis 3x6 (NO trackball variant)
// Uses crkbd split_3x6_3 layout (3 thumb keys per side)
// Compile with: qmk compile -kb crkbd -km simoncolemak_bastardkb
