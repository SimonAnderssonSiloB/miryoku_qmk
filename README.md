...
| bastardkb/charybdis/3x6 | `simoncolemak` | Split 3x6, with trackball (2 right thumbs) |
...
qmk compile -kb bastardkb/charybdis/3x6 -km simoncolemak
```
...
qmk flash -kb bastardkb/charybdis/3x6 -km simoncolemak
```
